...
const
  ...
  RegExprLineSeparators : RegExprString =#$a; // default value for LineSeparators   #$d#$a{$IFDEF UniCode}#$b#$c#$2028#$2029#$85{$ENDIF};
  RegExprLinePairedSeparator : RegExprString ='';// default value for LinePairedSeparator  #$d#$a;
